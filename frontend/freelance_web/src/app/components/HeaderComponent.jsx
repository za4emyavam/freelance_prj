                ...
                <div
                    ...
                    <div className="flex-auto">
                        <Link to="/contractor/tasks"
                              className={/^\/contractor\/tasks(?:\/|$)/.test(location.pathname) ? 'no-underline font-extrabold text-blue-600' : 'no-underline text-black'}>All tasks</Link>
                    </div>
                    <div className="flex-auto">
                        <Link to="/contractor/your_tasks"
                              className={/^\/contractor\/your_tasks(?:\/|$)/.test(location.pathname) ? 'no-underline font-extrabold text-blue-600' : 'no-underline text-black'}>Your tasks</Link>
                    </div>
                </div>
            </nav>
...
export default function HeaderComponent() {
    ...
    return (
        <div className={currentLocation.pathname === '/' ? 'hidden' : 'd-block'}>
